...
This does not mean we can replace code with prompt transcripts and pretend that is engineering. But it does force a clearer distinction between a few things:
